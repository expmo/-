...
- 用 markdown重新进行了整理，以适合自己风格的

- 所有示例都已在chrome浏览器上验证通过，验证过程中已修正原文中存在的几处笔误

- 关于grid和flex兼容和性能问题，个人认为发展到现在，grid和flex并不像以上列表说的那样，它们反而更具优势，后续再作补充
...
相比传统的“浮动+定位”布局，现代布局方案中的grid和flex更有优势，必定是未来的主流。时至今日，它们的性能及兼容性问题应该已经得到了极大的改善，需要收集最新的资料以做论证，可以从以下几方面考察：
